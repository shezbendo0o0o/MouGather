...
class mougather:
    ...
    def search(username, Mode):
        ...
        if opt == 1:
            ...
            mougather.Controll(username, nomefile, identity, report, subject,
            ...
            Nsfw = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Username", "Default", "Nsfw") +
                    Font.Color.GREEN + "[#MOUGATHER#]" + Font.Color.WHITE + "-->"))
            if Nsfw == 1:
            ...
            mougather.Scraping(report,username,http_proxy,InstagramParams,PostLocations, PostGpsCoordinates,TwitterParams)
        ...
        Recaps = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                filename, "Default", "Hypo", "None") + Font.Color.GREEN + "[#MOUGATHER#]" + Font.Color.WHITE + "-->"))
        if Recaps == 1:
            if opt == 1:
        ...
        if count == 1:
            ...
            if choice == 1:
                mougather.Google_dork(username)
                mougather.Yandex_dork(username)
