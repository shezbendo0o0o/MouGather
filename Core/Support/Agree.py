...
class One_time:
    ...
    def Agreement():
        Clear.Screen.Clear()
        f = open("Banners/MouGather_Agree.txt", "r")
        reader = f.read()
        f.close()
        ...
        try:
            choice = str(input(Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Eula", "Text", "None") +
                         Font.Color.GREEN + "(Y)" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Eula", "Agree", "None") + Font.Color.RED + "(N)" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Eula", "Disagree", "None") + Font.Color.GREEN + "[#MOUGATHER#]" + Font.Color.WHITE + "-->"))
